...
class Node:
    ...
    def __init__(self, game_state, index, parent, nn):
        ...
        self.nn_prediction = nn.predict(np.reshape(self.proper_board, (1, 6, 7, 3)))
    ...
    def select(self):
        ...
        if self.children[selected_index] is None:
            ...
            self.children[selected_index] = Node(new_game_state, selected_index, self, self.nn)
            end = True
